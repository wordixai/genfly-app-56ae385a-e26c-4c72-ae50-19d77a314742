...
const Index = () => {
  ...
  return <div className="min-h-screen bg-gradient-to-br from-orange-400 via-pink-500 to-yellow-400 relative overflow-hidden">
      {/* Background Pattern */}
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="relative">
                ...
                {cartItems > 0 && <span className="absolute -top-2 -right-2 bg-pink-500 text-white text-xs rounded-full h-5 w-5 flex items-center justify-center animate-bounce">
                    {cartItems}
                  </span>}
              </div>
            </div>
      ...
      <section className="relative z-10 py-20 px-4">
        <div className="container mx-auto text-center">
          <div className="bg-white/95 backdrop-blur-sm rounded-3xl border-4 border-black shadow-2xl p-8 transform rotate-1 pop-frame">
            <h2 className="text-black text-6xl md:text-8xl font-black mb-4 comic-font transform -rotate-2">BOM!</h2>
            <p className="text-pink-600 text-2xl font-bold md:text-3xl mb-8 comic-font">Explosive ashion & Art!</p>
                ...
                <div className="bg-white rounded-2xl border-4 border-black shadow-lg transform hover:rotate-2 transition-all duration-300 pop-frame overflow-hidden">
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center mb-3">
                      {[...Array(5)].map((_, i) => <Star key={i} className={`h-4 w-4 ${i < product.rating ? 'text-yellow-400 fill-yellow-400' : 'text-gray-300'}`} />)}
                    </div>
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <button onClick={addToCart} className="bg-gradient-to-r from-orange-500 to-pink-500 text-white font-black px-4 py-2 rounded-full border-2 border-black hover-bounce comic-font transform hover:scale-105 transition-all">
                        ADD TO CART
                      </button>
                    </div>
                  </div>
        ...
        <div className="container mx-auto text-center">
          <div className="bg-gradient-to-r from-yellow-400 to-pink-500 rounded-3xl border-4 border-black shadow-2xl p-8 transform -rotate-1 pop-frame">
            ...
            <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
              <input type="email" placeholder="Your email here..." className="flex-1 px-4 py-3 rounded-full border-4 border-black font-bold comic-font focus:outline-none focus:ring-4 focus:ring-pink-300" />
